...
public class PenjualanCoilController {
    ...
    @FXML
    private TableView<PenjualanBahanHead> penjualanTable;
    @FXML
    private TableColumn<PenjualanBahanHead, String> noPenjualanColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> tglPenjualanColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> gudangColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> namaCustomerColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> alamatCustomerColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> paymentTermColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> totalPenjualanColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> kursColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, Number> totalPenjualanRpColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, Number> pembayaranColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, Number> sisaPembayaranColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> catatanColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> namaSalesColumn;
    @FXML
    private TableColumn<PenjualanBahanHead, String> kodeUserColumn;
