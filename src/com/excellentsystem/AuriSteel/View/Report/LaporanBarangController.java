...
import com.excellentsystem.AuriSteel.View.Dialog.CetakLabelController;
...
public class LaporanBarangController {
    ...
    public void initialize() {
        ...
        MenuItem barcode = new MenuItem("Cetak Label");
    ...
    private void cetakBarcode(StokBarang b) {
        if (b == null) {
            Stage stage = new Stage();
            FXMLLoader loader = mainApp.showDialog(mainApp.MainStage, stage, "View/Dialog/CetakLabel.fxml");
