...
public class LaporanPembelianController {
    ...
    @FXML
    private TreeTableView<PembelianBahanHead> pembelianTable;
    @FXML
    private TreeTableColumn<PembelianBahanHead, String> noPembelianColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, String> tglPembelianColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, String> gudangColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, String> namaSupplierColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, Number> totalPembelianColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, Number> totalBebanPembelianColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, Number> grandTotalColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, Number> pembayaranColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, Number> sisaPembayaranColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, String> catatanColumn;
    @FXML
    private TreeTableColumn<PembelianBahanHead, String> kodeUserColumn;
            ...
            final TreeTableRow<PembelianBahanHead> row = new TreeTableRow<PembelianBahanHead>() {
                ...
                public void updateItem(PembelianBahanHead item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        for (Otoritas o : sistem.getUser().getOtoritas()) {
                            if (o.getJenis().equals("Detail Pembelian Bahan") && o.isStatus() && item.getStatus() != null) {
