...
public class LaporanBarangDikirimController {
    ...
    @FXML
    private TreeTableView<PenjualanBarangDetail> penjualanDetailTable;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> noPenjualanColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> tglPenjualanColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> gudangColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> namaCustomerColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> namaSalesColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> kodeBarangColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> namaBarangColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> keteranganColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, String> satuanColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> qtyColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> tonaseColumn;
    ...
    public void initialize() {
        ...
        tonaseColumn.setCellValueFactory(cellData
                -> new SimpleDoubleProperty(cellData.getValue().getValue().getBarang().getBerat() * cellData.getValue().getValue().getQty()));
    ...
    private void hitungTotal() {
        ...
        for (PenjualanBarangDetail temp : filterData) {
            totalTonase = totalTonase + (temp.getBarang().getBerat() * temp.getQty());
        ...
        for (String temp : groupBy) {
            ...
            for (PenjualanBarangDetail detail : filterData) {
                ...
                if (status) {
                    ...
                    totalTonase = totalTonase + (detail.getBarang().getBerat() * detail.getQty());
                    parent.getChildren().addAll(new TreeItem<>(detail));
                }
            }
            parent.getValue().setQty(totalQty);
            parent.getValue().getBarang().setBerat(totalTonase/totalQty);
