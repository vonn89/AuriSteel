...
public class LaporanUntungRugiSummaryController {
    ...
    @FXML
    private ComboBox<String> periodeBeforeCombo;
    @FXML
    ...
    @FXML
    private Label costOfRevenueLabel;
    @FXML
    private Label grossIncomeLabel;
    @FXML
    private Label salesExpenseLabel;
    @FXML
    private Label generalAdministrationLabel;
    @FXML
    private Label operatingExpenseLabel;
    @FXML
    private Label incomeOperatingLabel;
    @FXML
    private Label otherIncomeLabel;
    @FXML
    private Label otherChargesLabel;
    @FXML
    private Label totalOtherIncomeChargesLabel;
    @FXML
    private Label incomeBeforeTaxLabel;
    @FXML
    ...
    @FXML
    private Label grossIncomePercentageLabel;
    @FXML
    private Label operatingExpensePercentageLabel;
    @FXML
    private Label incomeOperatingPercentageLabel;
    @FXML
    private Label incomeBeforeTaxPercentageLabel;
    @FXML
    private Label netIncomePercentageLabel;

    @FXML
    private Label revenue2Label;
    @FXML
    private Label costOfRevenue2Label;
    @FXML
    private Label grossIncome2Label;
    @FXML
    private Label salesExpense2Label;
    @FXML
    private Label generalAdministration2Label;
    @FXML
    private Label operatingExpense2Label;
    @FXML
    private Label incomeOperating2Label;
    @FXML
    private Label otherIncome2Label;
    @FXML
    private Label otherCharges2Label;
    @FXML
    private Label totalOtherIncomeCharges2Label;
    @FXML
    private Label incomeBeforeTax2Label;
    @FXML
    private Label incomeTax2Label;
    @FXML
    private Label netIncome2Label;

    @FXML
    private Label grossIncomePercentage2Label;
    @FXML
    private Label operatingExpensePercentage2Label;
    @FXML
    private Label incomeOperatingPercentage2Label;
    @FXML
    private Label incomeBeforeTaxPercentage2Label;
    @FXML
    private Label netIncomePercentage2Label;
    ...
    private void getBefore() {
        try (Connection con = Koneksi.getConnection()) {
            ...
            incomeBeforeTaxPercentageLabel.setText(pr.format((penjualan - hpp + salesExpense + generalAdministrationExpense + otherIncome + otherCharge)
                    / penjualan * 100) + " %");
            netIncomePercentageLabel.setText(pr.format((penjualan - hpp + salesExpense + generalAdministrationExpense + otherIncome + otherCharge + incomeTax) / penjualan * 100) + " %");
    ...
    private void getNow() {
        try (Connection con = Koneksi.getConnection()) {
            ...
            incomeOperatingPercentage2Label.setText(pr.format(
                    (penjualan - hpp + salesExpense + generalAdministrationExpense) / penjualan * 100) + " %");
            incomeBeforeTaxPercentage2Label.setText(pr.format((penjualan - hpp + salesExpense + generalAdministrationExpense + otherIncome + otherCharge)
                    / penjualan * 100) + " %");
            netIncomePercentage2Label.setText(pr.format((penjualan - hpp + salesExpense + generalAdministrationExpense + otherIncome + otherCharge + incomeTax) / penjualan * 100) + " %");
