...
public class LaporanPembelianBarangController  {
    ...
    @FXML private TreeTableView<PembelianBarangHead> pembelianTable;
    @FXML private TreeTableColumn<PembelianBarangHead, String> noPembelianColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, String> tglPembelianColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, String> gudangColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, String> namaSupplierColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, Number> totalPembelianColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, Number> totalBebanPembelianColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, Number> grandTotalColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, Number> pembayaranColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, Number> sisaPembayaranColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, String> catatanColumn;
    @FXML private TreeTableColumn<PembelianBarangHead, String> kodeUserColumn;
