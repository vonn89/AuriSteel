...
public class LaporanBarangTerjualController {
    ...
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> nilaiColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> totalNilaiColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> hargaJualColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> totalColumn;
    @FXML
    private TreeTableColumn<PenjualanBarangDetail, Number> persentaseColumn;
