...
public class LaporanKartuStokBahanController {
    ...
    @FXML
    private TableColumn<StokBahan, String> kodeKategoriColumn;
    @FXML
    ...
    @FXML
    private TableColumn<StokBahan, String> tanggalColumn;

    @FXML
    private TableColumn<StokBahan, Number> beratAwalColumn;
    @FXML
    private TableColumn<StokBahan, Number> beratInColumn;
    @FXML
    private TableColumn<StokBahan, Number> beratOutColumn;
    @FXML
    private TableColumn<StokBahan, Number> beratAkhirColumn;
