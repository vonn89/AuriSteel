...
public class DataCustomerController {
    ...
    @FXML
    private TableColumn<Customer, String> negaraColumn;
    @FXML
    ...
    @FXML
    private TableColumn<Customer, String> kodeSalesColumn;
    @FXML
    ...
    @FXML
    private TableColumn<Customer, Number> hutangColumn;
    @FXML
    private TableColumn<Customer, Number> depositColumn;
    @FXML
    ...
    private void newCustomer() {
        ...
        x.saveButton.setOnAction((ActionEvent ev) -> {
            if (x.kodeSalesCombo.getSelectionModel().getSelectedItem() == null || x.kodeSalesCombo.getSelectionModel().getSelectedItem().equals("")) {
                mainApp.showMessage(Modality.NONE, "Warning", "Sales belum dipilih");
            } else if (x.limitHutangField.getText().equals("0")) {
