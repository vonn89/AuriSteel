...
public class AddProduksiController {
    ...
    @FXML
    public TableView<ProduksiHead> produksiHeadTable;
    @FXML
    private TableColumn<ProduksiHead, String> noProduksiColumn;
    @FXML
    private TableColumn<ProduksiHead, String> tglProduksiColumn;
    @FXML
    private TableColumn<ProduksiHead, String> kodeGudangColumn;
    @FXML
    private TableColumn<ProduksiHead, String> jenisProduksiColumn;
    @FXML
    private TableColumn<ProduksiHead, Number> materialCostColumn;
    @FXML
    private TableColumn<ProduksiHead, Number> totalBebanProduksiColumn;
    @FXML
