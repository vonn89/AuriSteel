...
public class NewPindahBarangController {
    ...
    @FXML
    private TableView<PindahBarangDetail> pengirimanDetailTable;
    @FXML
    private TableColumn<PindahBarangDetail, String> kodeBarangColumn;
    @FXML
    private TableColumn<PindahBarangDetail, String> namaBarangColumn;
    @FXML
    private TableColumn<PindahBarangDetail, String> keteranganColumn;
    @FXML
    private TableColumn<PindahBarangDetail, String> satuanColumn;
    @FXML
    private TableColumn<PindahBarangDetail, Number> qtyColumn;
    ...
    public void setDetailPindah(String noPindah, boolean verifikasi) {
