...
public class DetailBebanProduksiController {
    ...
    @FXML
    private TableView<BebanProduksiDetail> bebanProduksiTable;
    @FXML
    private TableColumn<BebanProduksiDetail, String> noBebanColumn;
    @FXML
    private TableColumn<BebanProduksiDetail, String> tglBebanColumn;
    @FXML
    private TableColumn<BebanProduksiDetail, String> keteranganColumn;
    @FXML
    private TableColumn<BebanProduksiDetail, Number> jumlahRpColumn;
