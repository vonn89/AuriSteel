...
public class NewPengirimanController {
    ...
    @FXML
    private TableView<PenjualanBarangDetail> pengirimanDetailTable;
    @FXML
    ...
    @FXML
    private TableColumn<PenjualanBarangDetail, String> catatanInternColumn;
    @FXML
    ...
    @FXML
    private TextField namaInvoiceField;
    @FXML
