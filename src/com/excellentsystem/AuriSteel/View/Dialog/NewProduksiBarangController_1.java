 ...
 * @author Xtreme
 */
public class NewProduksiBarangController_1 {
    ...
    @FXML
    private TableColumn<ProduksiDetailBahan, Boolean> bahanHabisColumn;
    @FXML
    ...
    @FXML
    private Label noProduksiField;
    @FXML
    private Label tglProduksiField;
    @FXML
    private Button addOperatorButton;
    @FXML
    private Button resetOperatorButton;
    @FXML
    private TextArea operatorField;
    @FXML
