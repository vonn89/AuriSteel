...
public class UserMesinAppDAO {
    ...
    public static void deleteByMesin(Connection con, Mesin mesin)throws Exception{
        PreparedStatement ps = con.prepareStatement("delete from tm_user_mesin_app where kode_mesin=?");
